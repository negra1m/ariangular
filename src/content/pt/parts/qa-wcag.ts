...
export const qaWcag: Part = {
  ...
  summary:
    'Esta seção serve como guia operacional para desenvolvimento, QA, refinamentos, stories, PRs e releases. O objetivo não é decorar a WCAG, mas aplicá-la diariamente.',
  sections: [
    {
      ...
      blocks: [
        {
          ...
          rows: [
            ...
            ['2.4.3', 'Ordem de foco.'],
            ['2.4.6', 'Títulos e labels.'],
            ['2.4.7', 'Foco visível.'],
            ['3.3.1', 'Identificação de erros.'],
            ['3.3.2', 'Instruções e labels.'],
            ['4.1.2', 'Name, Role e Value.'],
          ],
        },
      ],
    },
    {
      ...
      summary:
        'Critérios que Mais Geram Bugs: 2.4.3 Ordem de foco.; 4.1.2 Name Role Value.; 3.3.1 Identificação de erros.',
      blocks: [
        {
          kind: 'list',
          ordered: true,
    ...
    },
    {
      ...
      summary:
        'Checklist de Desenvolvimento: Existe HTML semântico?; Existe label para todos os campos?; Existe nome acessível?',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Checklist de Pull Request: Novos componentes foram testados?; O foco continua correto?; Não houve regressão de leitor de tela?',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Checklist de QA: Todos os botões são anunciados?; Todos os links são anunciados?; Todos os campos possuem label?',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Checklist para TalkBack: Navegar a tela inteira.; Validar headings.; Validar botões.',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Checklist para VoiceOver: Navegar tela completa.; Validar todos os elementos focáveis.; Validar formulários.',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Quando Abrir um Bug de Acessibilidade?: Não conseguir concluir uma tarefa.; Não conseguir identificar um elemento.; Não conseguir navegar.',
      blocks: [
        {
          kind: 'paragraph',
      ...
      blocks: [
        {
          ...
          rows: [
            ['Crítico', 'Usuário não conclui a jornada.'],
            ['Alto', 'Grande dificuldade de navegação.'],
    ...
    },
    {
      ...
      summary:
        'Exemplos de Bugs Críticos: Botão principal sem nome.; Modal inacessível.; Erro não anunciado.',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Exemplos de Bugs Médios: Heading incorreto.; Texto alternativo ruim.; Tooltip sem descrição.',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Definition of Done Acessível: WCAG AA atendida.; Teclado funcionando.; TalkBack validado.',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Checklist para Revisão de Tela Nova: Existe H1?; Existe estrutura semântica?; Existe ordem lógica?',
      blocks: [
        {
          kind: 'list',
          ordered: true,
