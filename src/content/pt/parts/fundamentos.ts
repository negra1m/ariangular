...
export const fundamentos: Part = {
  ...
  summary:
    'Primeira parte da documentação de acessibilidade para aplicações Angular, VoiceOver e TalkBack.',
  sections: [
    {
      ...
      summary:
        'Acessibilidade é a capacidade de um produto digital ser utilizado por todas as pessoas, independentemente de limitações visuais, auditivas, motoras, cog…',
      blocks: [
        {
          kind: 'paragraph',
    ...
    },
    {
      ...
      title: 'WCAG 2.2',
      summary:
        'A WCAG (Web Content Accessibility Guidelines) é o conjunto mais utilizado no mundo para avaliar acessibilidade digital.',
      blocks: [
        {
          kind: 'paragraph',
        ...
        },
        {
          ...
          rows: [
            ...
            ['AA', 'Padrão adotado pela maioria das empresas.'],
            ['AAA', 'Nível mais rigoroso.'],
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'list',
          ordered: false,
          items: ['Fluxos consistentes.', 'Mensagens claras.', 'Erros compreensíveis.'],
        },
        {
          kind: 'heading',
          level: 1,
        ...
        },
        {
          kind: 'list',
          ordered: false,
          items: ['Compatível com tecnologias assistivas.', 'HTML semântico.', 'ARIA correta.'],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'list',
          ordered: false,
          items: ['Nome acessível.', 'Role correta.', 'Estado correto.'],
        },
        {
          kind: 'heading',
          level: 1,
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          kind: 'list',
          ordered: false,
          items: ['Títulos.', 'Botões.', 'Links.', 'Campos.', 'Landmarks.'],
        },
        {
          kind: 'callout',
          tone: 'warning',
    ...
    },
    {
      ...
      title: 'Landmarks',
      summary:
        'Landmarks permitem que leitores de tela naveguem rapidamente pelas regiões importantes da página.',
      blocks: [
        {
          kind: 'paragraph',
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'table',
          headers: ['Pergunta', 'Exemplo'],
          rows: [
            ['Qual é o nome?', 'Salvar'],
            ['Qual é a role?', 'Botão'],
            ['Qual é o estado?', 'Desabilitado'],
          ],
        },
        {
          kind: 'heading',
    ...
    },
    {
      ...
      summary:
        'Erros mais comuns encontrados em Angular: Div clicável simulando botão.; Ícone clicável sem aria-label.; Input apenas com placeholder.',
      blocks: [
        {
          kind: 'list',
          ordered: false,
