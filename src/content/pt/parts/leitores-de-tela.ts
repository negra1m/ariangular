...
export const leitoresDeTela: Part = {
  ...
  summary:
    'Nesta seção vamos focar em como leitores de tela realmente se comportam. Muitos componentes estão tecnicamente corretos no HTML, mas a experiência final para o usuário continua ruim.',
  sections: [
    {
    ...
    },
    {
      ...
      title: 'Modais',
      summary:
        'Modais: Foco vai para o modal.; Conteúdo anterior fica inacessível.; Tab navega apenas dentro dele.',
      blocks: [
        {
          kind: 'paragraph',
          text: 'Ao abrir:',
        ...
        },
        {
          kind: 'list',
          ordered: false,
          items: ['Foco retorna ao elemento que abriu.'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'table',
          headers: ['Cenário', 'Diferenças comuns'],
          rows: [
            ['Forms', 'Pequenas diferenças de anúncio.'],
            ['Tabs', 'Ordem de anúncio pode variar.'],
            ['Modais', 'Foco pode variar.'],
            ['Selects', 'Muito dependente da implementação.'],
          ],
        },
      ],
    },
    {
      ...
      summary:
        'Roteiro de Teste Manual: Ativar leitor de tela.; Percorrer toda tela.; Verificar títulos.',
      blocks: [
        {
          kind: 'list',
          ordered: true,
    ...
    },
    {
      ...
      summary:
        'Bugs Mais Comuns Encontrados em Produção: Botão sem nome acessível.; Ícone clicável sem label.; Modal sem foco.',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Checklist Final de TalkBack e VoiceOver: Todos os elementos possuem nome?; Todos possuem role correta?; Estado é anunciado?',
      blocks: [
        {
          kind: 'list',
          ordered: false,
