...
export const componentes: Part = {
  ...
  summary:
    'Esta seção cobre os componentes que mais geram bugs de acessibilidade em aplicações Angular.',
  sections: [
    {
      id: 'botoes',
      partId: 'componentes',
      ...
      blocks: [
        {
          kind: 'list',
          ordered: false,
          items: ['Usar caption.', 'Usar th.', 'Usar scope.', 'Evitar tabela feita com div.'],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'list',
          ordered: false,
          items: ['Botão anterior.', 'Botão próximo.', 'Botão pausar.', 'Slides identificáveis.'],
        },
      ],
    },
    {
      ...
      summary:
        'Infinite Scroll: Anunciar novos itens carregados.; Preservar foco.; Evitar mudanças bruscas.',
      blocks: [
        {
          kind: 'list',
          ordered: false,
    ...
    },
    {
      ...
      summary:
        'Checklist de Componentes: Possui nome acessível?; Possui role correta?; Possui estado correto?',
      blocks: [
        {
          kind: 'list',
          ordered: false,
